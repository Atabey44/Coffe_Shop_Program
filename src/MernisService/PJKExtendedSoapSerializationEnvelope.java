...
public class PJKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(PJKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new PJKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static PJKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static PJKDateTimeConverter dateTimeConverter = new PJKStandardDateTimeConverter();

    public PJKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PJKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PJKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=PJKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,PJKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=PJKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
