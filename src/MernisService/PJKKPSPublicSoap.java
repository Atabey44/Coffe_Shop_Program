...
public class PJKKPSPublicSoap
{
    ...
    public PJKKPSPublicSoap(){}

    public PJKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public PJKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        PJKExtendedSoapSerializationEnvelope envelope= new PJKExtendedSoapSerializationEnvelope(PJKExtendedSoapSerializationEnvelope.VER11);
